-- ==============================================================================
-- FIX: Propagar is_recurring e recurrence_period para financial_transactions
-- quando proposta é aceita via accept_proposal_v1
-- ==============================================================================
...
BEGIN
  ...
  IF v_schedule_count > 0 THEN
      ...
      SELECT
        ...
        'INCOME',
        'CLIENT_PAYMENT',
        'Pagamento Proposta: ' || description,
        amount,
        CASE WHEN paid = true THEN 'PAID' ELSE 'PENDING' END,
        v_project_id,
        v_proposal.id,
        v_proposal.client_id,
        due_date,
