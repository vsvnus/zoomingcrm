...
export default function Home() {
  ...
  return (
    <main
      ...
      className="relative min-h-screen bg-black text-white selection:bg-emerald-500/30 selection:text-emerald-50 overflow-hidden"
    >
      ...
      <div className="fixed inset-0 z-0 pointer-events-none">
        ...
        {/* Grid */}
        <div className="absolute inset-0 bg-[url('/grid.svg')] opacity-[0.05] bg-center [mask-image:radial-gradient(ellipse_at_center,white,transparent_80%)]" />
      </div>
      ...
      <section className="relative z-10 pt-32 pb-24 md:pt-48 md:pb-32 px-6">
        <div className="max-w-7xl mx-auto flex flex-col items-center text-center">
          ...
          <motion.div
            ...
            className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full border border-white/10 bg-white/5 backdrop-blur-sm text-sm font-medium text-zinc-300 mb-8 hover:bg-white/10 transition-colors cursor-default"
          >
          ...
          <motion.h1
            ...
            className="text-5xl md:text-7xl lg:text-8xl font-bold tracking-tight leading-[0.95] mb-8 bg-clip-text text-transparent bg-gradient-to-b from-white via-white to-zinc-500"
          >
            Sua Produtora, <br />
            <span className="text-white">Finalmente Organizada.</span>
          </motion.h1>
          ...
          >
            <Link
              href="/login"
              className="group relative w-full sm:w-auto px-8 py-4 bg-white text-black text-base font-bold rounded-xl hover:bg-zinc-200 transition-all flex items-center justify-center gap-2 active:scale-95"
            >
              Começar Gratuitamente
              <ArrowRight className="w-4 h-4 group-hover:translate-x-1 transition-transform" />
              <div className="absolute inset-0 rounded-xl ring-2 ring-white/50 ring-offset-2 ring-offset-black opacity-0 group-hover:opacity-100 transition-opacity" />
            </Link>
            <Link
              href="#demo"
              className="group w-full sm:w-auto px-8 py-4 bg-zinc-900 border border-zinc-800 text-white text-base font-medium rounded-xl hover:bg-zinc-800 transition-all flex items-center justify-center gap-2"
            >
              <Play className="w-4 h-4 fill-current group-hover:text-emerald-400 transition-colors" />
              Ver Demo
            </Link>
          </motion.div>
        </div>
      ...
      <section className="border-y border-white/5 bg-white/[0.02]">
        <div className="max-w-7xl mx-auto px-6 py-16">
          <p className="text-center text-sm font-bold text-zinc-600 mb-10 uppercase tracking-[0.2em]">
      ...
      <section className="py-32 bg-zinc-900/20 border-t border-white/5 relative overflow-hidden">
        ...
        <div className="absolute bottom-0 left-0 w-1/2 h-full bg-gradient-to-r from-blue-900/10 to-transparent pointer-events-none" />
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          ...
          <div className="grid lg:grid-cols-2 gap-20 items-center mb-40">
            <div>
              <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-emerald-500/10 text-emerald-400 text-xs font-bold uppercase tracking-wider mb-8 border border-emerald-500/20">
                <Zap className="w-3 h-3" /> Vendas & Automação
              </div>
              <h3 className="text-4xl md:text-5xl font-bold text-white mb-6 leading-tight">
                A Proposta vira o Projeto. <br />
                <span className="text-zinc-500">Sem digitar nada.</span>
              </h3>
            ...
            <div className="relative group perspective-1000">
              ...
              <div className="relative bg-[#09090b] border border-zinc-800 rounded-2xl p-8 shadow-2xl rotate-y-6 transform transition-transform duration-500 group-hover:rotate-0">
                {/* Header */}
                <div className="flex justify-between items-center mb-8 pb-6 border-b border-zinc-800">
                  <div>
                    <div className="text-xs text-zinc-500 uppercase tracking-widest mb-1">PROPOSTA #882</div>
                    <div className="font-bold text-xl">Fashion Film - Summer 2025</div>
                  </div>
                  <div className="text-right">
                    <div className="text-emerald-400 font-mono font-bold text-lg">R$ 18.500,00</div>
                    <div className="text-xs text-zinc-500">Válido até 15/03</div>
                  </div>
                </div>
                ...
                <div className="space-y-6">
                  <div className="bg-zinc-900 rounded-xl p-4 border border-zinc-800 flex gap-4 items-center">
                    ...
                    <div>
                      <div className="text-sm font-bold text-white">Vídeo Conceito</div>
                      <div className="text-xs text-zinc-500">Visualizar referência (02:15)</div>
                    </div>
                  </div>

                  <div className="space-y-3">
                    <div className="flex justify-between text-sm py-2 border-b border-zinc-800/50">
                      <span className="text-zinc-300">3x Diárias de Gravação</span>
                      <span className="text-zinc-500">R$ 4.500</span>
                    </div>
                    <div className="flex justify-between text-sm py-2 border-b border-zinc-800/50">
                      <span className="text-zinc-300">Edição e Color Grading</span>
                      <span className="text-zinc-500">R$ 6.000</span>
                    </div>
                    <div className="flex justify-between text-sm py-2 border-b border-zinc-800/50">
                      <span className="text-zinc-300">Trilha Sonora (Licenciamento)</span>
                      <span className="text-zinc-500">R$ 800</span>
                    </div>
                  </div>
                </div>
                ...
                <div className="mt-8 pt-6 border-t border-zinc-800 flex justify-between items-center">
                  ...
                  <button className="px-6 py-2 bg-white text-black text-sm font-bold rounded-lg hover:bg-zinc-200 transition-colors shadow-lg shadow-white/10">
                    ACEITAR PROPOSTA
                  </button>
                </div>
              </div>
              ...
              <div className="relative bg-[#09090b] border border-zinc-800 rounded-2xl p-8 shadow-2xl -rotate-y-6 transform transition-transform duration-500 group-hover:rotate-0">
                ...
                <div className="grid grid-cols-2 gap-4 mb-8">
                  <div className="bg-zinc-900/50 p-4 rounded-xl border border-zinc-800">
                    <div className="text-xs text-zinc-500 mb-2">Receita Prevista</div>
                  ...
                  <div className="bg-zinc-900/50 p-4 rounded-xl border border-zinc-800">
                    <div className="text-xs text-zinc-500 mb-2">Margem de Lucro</div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-center justify-between p-3 rounded-lg hover:bg-zinc-900/50 transition-colors">
                    <div className="flex items-center gap-3">
                      <div className="w-8 h-8 rounded-full bg-zinc-800 flex items-center justify-center text-zinc-400">
                        <Camera className="w-4 h-4" />
                      </div>
                      <div>
                        <div className="text-sm font-medium text-white">Aluguel Lente 24-70mm</div>
                        <div className="text-xs text-zinc-500">Locadora XYZ</div>
                      </div>
                    </div>
                    <div className="text-sm font-bold text-red-400">- R$ 350,00</div>
                  </div>
                  ...
                  <div className="flex items-center justify-between p-3 rounded-lg hover:bg-zinc-900/50 transition-colors">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <div className="text-sm font-medium text-white">Editor (João Silva)</div>
                        <div className="text-xs text-zinc-500">Diária de Edição</div>
                      </div>
                    </div>
                    <div className="text-sm font-bold text-amber-500 animate-pulse">Pendente</div>
                  </div>

                  <div className="flex items-center justify-between p-3 rounded-lg hover:bg-zinc-900/50 transition-colors border-t border-zinc-800/50">
                    <div className="flex items-center gap-3">
                      <div className="w-8 h-8 rounded-full bg-emerald-500/10 flex items-center justify-center text-emerald-500">
                        <Wallet className="w-4 h-4" />
                      </div>
                      <div>
                        <div className="text-sm font-medium text-white">Entrada Projeto Nike</div>
                        <div className="text-xs text-zinc-500">Pagamento confirmado</div>
                      </div>
                    </div>
                    <div className="text-sm font-bold text-emerald-400">+ R$ 21.000,00</div>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="max-w-4xl mx-auto text-center relative z-10">
          ...
          >
            <h2 className="text-4xl md:text-6xl font-bold text-white mb-8">
              ...
              ser <span className="text-transparent bg-clip-text bg-gradient-to-r from-emerald-400 to-emerald-600">profissional.</span>
            </h2>
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              <Link
                href="/login"
                className="w-full sm:w-auto px-10 py-5 bg-white text-black text-lg font-bold rounded-xl hover:bg-zinc-200 transition-colors shadow-[0_0_40px_-10px_rgba(255,255,255,0.3)] hover:shadow-[0_0_60px_-15px_rgba(255,255,255,0.4)]"
              >
                Criar Conta Grátis
              </Link>
            </div>
            <p className="mt-8 text-sm text-zinc-600 font-medium">
...
function FeatureItem({ title, text }: { title: string, text: string }) {
  return (
    <div className="flex gap-4">
      <div className="mt-1 w-6 h-6 rounded-full bg-zinc-800 flex items-center justify-center flex-shrink-0 border border-zinc-700">
      ...
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center gap-8">
        <div className="flex flex-col gap-4">
          ...
          <div className="text-zinc-500 text-sm max-w-xs">
            © 2025 Zooming CRM. <br />
            Feito com <span className="text-red-900">♥</span> por quem entende de set.
          </div>
        </div>
...
function PainCard({ icon, title, description }: { icon: any, title: string, description: string }) {
  return (
    <div className="group bg-zinc-900/40 border border-zinc-800 p-8 rounded-2xl text-left hover:border-red-500/30 hover:bg-zinc-900/60 transition-all duration-300">
      <div className="mb-6 p-3 bg-zinc-950 inline-flex rounded-xl border border-zinc-800 group-hover:border-red-500/30 group-hover:scale-110 transition-all duration-300">
        {icon}
      </div>
      <h3 className="text-xl font-bold text-white mb-3 group-hover:text-red-100 transition-colors">{title}</h3>
