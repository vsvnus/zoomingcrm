...
export function CompanyForm({ initialData }: CompanyFormProps) {
    ...
    const form = useForm<OrganizationFormData>({
        ...
        defaultValues: {
            ...
            primaryColor: initialData.primary_color || initialData.primaryColor || '#000000',
            logo: initialData.logo || '',
            showBankInfo: initialData.show_bank_info ?? initialData.showBankInfo ?? true,
            defaultTerms: initialData.default_terms || initialData.defaultTerms || '',
        },
    })
